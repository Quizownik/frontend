...
import CategoryStatisticsModal from '@/app/[locale]/components/profile/CategoryStatisticsModal';
...
export default function ResultsPage() {
    ...
    const fetchCategoryStats = async () => {
        ...
        try {
            const response = await fetch(`/${locale}/api/result/showPlots`);
            ...
            console.error('Błąd pobierania statystyk kategorii:', err);
            setError('Nie udało się załadować statystyk kategorii. Spróbuj ponownie później.');
        } finally {
    ...
    return (
        <main className="min-h-screen font-quiz px-4 py-10 text-black">
                ...
                <div className="p-6">
                    <div className="flex justify-between mb-6">
                        ...
                        <button
                            ...
                            className="inline-flex items-center px-4 py-2 bg-quizPink text-white rounded hover:bg-pink-600 transition"
                        >
                            {isLoadingStats ? (
                                <>
            ...
            {showStatsModal && categoryStats.length > 0 && (
                <CategoryStatisticsModal
